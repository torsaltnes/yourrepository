...
echo "    Browser UI  : http://localhost:5000/api/docs"
echo "    OpenAPI JSON: http://localhost:5000/openapi/v1.json"
echo ""
echo "  Verification (integration tests):"
echo "    dotnet test backend/tests/Greenfield.Api.IntegrationTests/Greenfield.Api.IntegrationTests.csproj"
echo ""
echo "  Verification (frontend build + unit tests):"
echo "    cd frontend && npm run build"
echo "    cd frontend && npm test -- --watch=false --browsers=ChromeHeadless"
echo "================================================================"
echo ""
